...
local function setup()
    ...
    -- Midia bindings (use xev to get key name)
        ...
        awful.key({ modkey }, "t", function()
            awful.spawn("/home/ztz/.local/bin/tgui")
        end, { description = "Execute tgui", group = "Apps" }),
    ...
    clientkeys = gears.table.join(
        ...
        awful.key({ modkey, "Shift" }, "Left", function(client)
            ...
            description = "Position the window on the left half of the screen.",
            group = "Tiling",
        }),
        awful.key({ modkey, "Shift" }, "Right", function(client)
            utils.snap_edge(client, "right")
        end, {
            description = "Position the window on the right half of the screen.",
            group = "Tiling",
        }),
